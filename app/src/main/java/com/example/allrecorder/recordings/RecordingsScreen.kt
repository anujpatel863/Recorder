...
fun RecordingsScreen(
    ...
    // Removed global playbackSpeed observation
        ...
        LazyColumn(
            ...
            if (recordingsToShow.isEmpty()) {
                item {
                    Box(modifier = Modifier.fillMaxWidth().padding(32.dp), contentAlignment = Alignment.Center) {
                        Text(if(searchResults != null) "No matching recordings" else "No recordings yet", color = Color.Gray)
                    }
                }
            }
            ...
            items(recordingsToShow, key = { it.recording.id }) { uiState ->
                RecordingItem(
                    ...
                    // FIX: Pass the recording to toggle speed for THIS item
...
// --- Starred Screen (Simplified copy of above) ---
@Composable
        ...
        Column(modifier = Modifier.clickable { isExpanded = !isExpanded }.padding(16.dp)) {
            ...
            AnimatedVisibility(visible = isExpanded) {
                PlayerControls(
                    ...
                    playbackSpeed = uiState.playbackSpeed, // FIX: Use individual speed
...
@Composable
private fun ItemOptionsMenu(onRename: () -> Unit, onDelete: () -> Unit, onSaveAs: () -> Unit) {
